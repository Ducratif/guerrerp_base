...
Shared.Blip = {
    ...
    Scale = 0.8,
    String = "Eboueur",
    StringStart = "Point de départ",
    StringGarage = "Garage",
    StringBag = "Poubelle"
}

Shared.Locale = {
    Start = "Appuyez sur ~INPUT_CONTEXT~ pour ~g~commencer~s~ le travail de ramassage d'ordures",
    Stop = "Appuyez sur ~INPUT_CONTEXT~ pour ~r~arrêter~s~ le travail de ramassage d'ordures",
    Store = "Appuyez sur ~INPUT_PICKUP~ pour ranger le ~g~véhicule~s~",
    VehicleNear = "Un véhicule ~r~bloque~s~ la sortie du ~r~véhicule~s~",
    Info = "Prenez votre camion à proximité puis rendez-vous aux ~b~points de départ~s~ indiqués sur la carte",
    TakeBag = "Appuyez sur ~INPUT_CONTEXT~ pour prendre le ~b~sac poubelle~w~",
    DropBag = "Appuyez sur ~INPUT_CONTEXT~ près du camion pour jeter le ~b~sac poubelle~w~",
    InvalidVehicle = "Ce ~r~véhicule n'est pas~s~ celui avec lequel vous avez ~r~commencé~s~ le travail",
}
