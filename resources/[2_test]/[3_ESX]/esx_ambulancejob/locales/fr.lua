...
Locales['fr'] = {
  ...
  -- Vehicles
  ['ambulance'] = 'ambulance',
  ['dlamb'] = 'Petite ambulance',
  ['emsnspeedo'] = 'Ambulance Avancer',
  ['dlemsb'] = 'Moto',
  ['dlgranger'] = 'Ranger Chef',
  ['dlbuffalo'] = 'Patron',
  ['dlswift'] = 'Ambulance Volante',
  ['helicopter_prompt'] = 'appuyez sur [E] pour accéder aux Actions de l\'hélicoptère.',
  ['garage_prompt'] = 'appuyez sur [E] pour accéder aux Actions des véhicules.',
  ...
  ['confirm_no'] = 'non',
  ['confirm_yes'] = 'oui',
  ['garage_notauthorized'] = 'Impossible de faire ceci.',
  -- Action Menu
