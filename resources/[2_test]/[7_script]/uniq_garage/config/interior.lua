...
return {
    ['autoshop'] = {
        ...
        Customization = {
            ...
            Purchasable = {
                ['Garage Style'] = {
                    { label = 'Auvun', name = 'entity_set_style_1', price = 250000, type = 'garage_style' },
                ...
                ['Tint'] = {
                    { label = 'Aucun', name = '', price = 187500, type = 'garage_tint' },
                    { label = 'Jaune', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 0 },
                    { label = 'Blanc', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 1 },
                    { label = 'Noir', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 2 },
                    { label = 'Vert', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 3 },
                    { label = 'Orange', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 4 },
                    { label = 'Rouge', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 5 },
                    { label = 'Rose', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 6 },
                    { label = 'Bleu', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 7 },
                    { label = 'Violet', name = 'entity_set_tints', price = 187500, type = 'garage_tint', color = 8 },
                },
            }
        }
    },
