...
Config.SkillCheckInputs = {"s", "d" } -- for ox only | "z", "a", "s", "d"
...
Config.MechanicLocations = {
  ...
  lscustoms = {
    ...
    locations = {
      {
        coords = vector3(-209.7201, -1321.5812, 30.4786),--Blips ?
        size = 6.5,
        showBlip = true,
      },
      {
        coords = vector3(-211.4475, -1323.4905, 30.8904),--Blips ?
        size = 3.0,
        showBlip = false,
        employeeOnly = true,
      }
    ...
    carLifts = { -- only usable by employees
      vector4(-223.4613, -1329.1501, 30.8904, 265.8345)--Elevateur
    },
    shops = {
      {
        name = "Fournitures d'entretien",--Shop
        coords = vector3(-197.0565, -1314.6929, 31.0893),
        size = 2.0,
        usePed = true,
        ...
        items = {
          { name = "engine_oil", label = "Huile moteur", price = 50 },
          { name = "tyre_replacement", label = "Remplacement des pneus", price = 2500 },
          { name = "clutch_replacement", label = "Remplacement de l'embrayage", price = 3000 },
          { name = "air_filter", label = "Filtre à air", price = 300 },
          { name = "spark_plug", label = "Bougie", price = 100 },
          { name = "suspension_parts", label = "Pièces de suspension", price = 2500 },
          { name = "brakepad_replacement", label = "Remplacement des plaquettes de frein", price = 1500 },
        },
      },
      {
        name = "Mises à niveau avancées",--Shop upgrade
        coords = vector3(-195.4083, -1320.9570, 31.0893),
        size = 2.0,
        usePed = true,
        pedModel = "s_m_m_lathandy_01",
        marker = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
        items = {
          { name = "turbocharger", label = "Turbo", price = 25000 },
          { name = "v8_engine", label = "Moteur V8", price = 40000 },
          { name = "ceramic_brakes", label = "Freins en céramique", price = 15000 },
        },
      }
    },
    stashes = {
      {
        name = "Bac à pièces",
        coords = vector3(-216.3396, -1314.8842, 34.6971),
        size = 2.0,
        usePed = true,
        pedModel = "s_m_m_lathandy_01",
        marker = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
