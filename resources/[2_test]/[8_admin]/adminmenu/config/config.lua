...
Config.Ban_Message = "Vous avez été banni de GuerreRP. Merci de nous contacter sur Discord." -- Ban message
...
Config.VehicleSystem = "wasabi-carlock"        -- cd_garage / qs-vehiclekeys / wasabi-carlock / qb-vehiclekeys
