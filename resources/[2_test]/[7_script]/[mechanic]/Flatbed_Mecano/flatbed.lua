...
AddTextEntry(controllerMessageLoweredCar, "Press ~INPUT_CONTEXT~ pour ~y~remonter ~w~le plateaux.~n~Press ~INPUT_DETONATE~ pour ~r~detacher ~w~the vehicule.")
AddTextEntry(controllerMessageLoweredNoCar, "Press ~INPUT_CONTEXT~  ~r~attacher le vehicule avant de remonter !!! ~w~le plateaux.~n~Press ~INPUT_DETONATE~ pour ~g~attacher ~w~le vehicule.")
AddTextEntry(controllerMessageRaised, "Press ~INPUT_CONTEXT~ pour ~y~descendre ~w~le plateaux.")
