...
Config.MarkerColor = { r = 22, g = 96, b = 7 }
...
Config.armyStations = {
	BASE = {
		...
		Cloakrooms = {
			vector3(-2350.04, 3266.2, 33)
		},
		Armories = {
			vector3(-2358.08, 3255.1, 33)
		},
		Vehicles = {
			{
				Spawner = vector3(-2114.22, 3231.1, 33),
				SpawnPoint = vector3(-2120.43, 3243.68, 33.5),
				Heading = 61.74
			}
		},
		Helicopters = {
			{
				Spawner = vector3(-2153.34, 3284.85, 33),
				SpawnPoint = vector3(-2139.98, 3277.36, 33),
				Heading = 205.08
			}
		},
		VehicleDeleters = {
			vector3(-2130.03, 3234.35, 33),
			vector3(-2145.78, 3264.17, 33)
		},
		BossActions = {
			vector3(-2357.56, 3251.7, 101)
		}
	}
}
...
Config.AuthorizedWeapons = {
	recruit = {
		...
		{ weapon = 'WEAPON_SMG', components = { 0, 0, 1000, 4000, nil }, price = 20000 },
...
Config.AuthorizedVehicles = {
	recruit = {
		{ model = 'Enduro', label = 'Moto Enduro'},
		{ model = 'crusader', label = 'Canis Crusader'},
		{ model = 'winky', label = 'winky Cruiser'},
		{ model = 'mesa3', label = 'Canis Mesa'},
		{ model = 'barracks', label = 'Barracks'},
		{ model = 'barracks2', label = 'Barracks Semi'},
		{ model = 'gladiator', label = 'Gladiator'}
	},
	sergeant = {
		{ model = 'Enduro', label = 'Moto Enduro'},
		{ model = 'crusader', label = 'Canis Crusader'},
