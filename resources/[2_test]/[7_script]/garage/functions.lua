...
RegisterNetEvent('LeDjo_Garage:CheckVeh2')
AddEventHandler('LeDjo_Garage:CheckVeh2', function()
    ...
    if cache.vehicle then
        TriggerServerEvent('LeDjo_Garage:SetCarDB', vehicleProps, plate, name)
        TriggerServerEvent('sy_carkeys:CreateKey', plate, name)
    else
        TriggerEvent('LeDjo_Garage:Notification', locale('dentrocar'))
    end
end)
