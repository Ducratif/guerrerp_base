...
class Anagram {
    ...
    start_loading_sequence() {
        this.flash_icon('.anagram_loading_icon_1', 'Booting password cracker');
        setTimeout(() => {
            this.play_sound('downloaded');
            this.complete_icon('.anagram_loading_icon_1');
            this.flash_icon('.anagram_loading_icon_2', 'Securing network channels');
        }, this.loading_time / 4);
        setTimeout(() => {
            this.play_sound('uploaded');
            this.complete_icon('.anagram_loading_icon_2');
            this.flash_icon('.anagram_loading_icon_3', 'Overcoming network defenses');
        }, this.loading_time / 2);
        setTimeout(() => {
            this.play_sound('accessed');
            this.complete_icon('.anagram_loading_icon_3');
            this.end_loading_sequence('Unauthorized access successful');
        }, this.loading_time);
    }
