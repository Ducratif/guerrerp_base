...
<template>
    <div class="dialog">
        <div class="dialog__header">
            <h1>Guerre<span>RP</span></h1>
        </div>
        <div class="dialog__body">
            <p class="dialog__body-hint">Nouvelle identité</p>
            <Form class="dialog__body-form" id="register" action="#" novalidate @submit="onSubmit" :validation-schema="schema">
                <div class="dialog__form-group">
                    ...
                    <div class="dialog__form-validation">
                        <Field id="firstname" type="text" name="firstname" placeholder="Ton nouveau prénom" validateOnInput />
                    </div>
                ...
                <div class="dialog__form-group">
                    ...
                    <div class="dialog__form-validation">
                        <Field id="lastname" type="text" name="lastname" placeholder="Nouveau nom de famille" validateOnInput />
                    </div>
                    <ErrorMessage name="lastname" class="dialog__form-message dialog__form-message--error" />
                </div>
                <div class="dialog__form-group">
                    <label for="dob">Date de naissance</label>
                    <Field id="dob" type="date" name="dob" placeholder="Mois/Jour/Année" validateOnInput />
                ...
                <button class="dialog__form-submit" id="submit" type="submit">
                    <i class="fas fa-user-plus"></i>Entré dans la ville
                </button>
            </Form>
        </div>
    </div>
