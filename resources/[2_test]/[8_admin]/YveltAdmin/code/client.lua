...
LettresItemsIndex = 1
YveltTeleportation = {Index = 1, "Vers lui", "Vers moi"}
...
adminGestPlayer = RageUI.CreateSubMenu(mainMenu, YveltConfig.MenuTitle, 'MENU GESTION DU JOUEUR')
...
--if YveltConfig.bypassRename then
--    print('Admin menu actif ! By Ducratif')
--end
