...
Garage.Version = false           -- Check GitHub version.
...
Garage.SharedGarage = false      -- S'il est "vrai" il pourra retirer les véhicules dans n'importe quel garage, s'il est "faux" il ne pourra retirer le véhicule que dans le garage qui l'a gardé.
...
Garage.Garages = {
    ...
    ['Fourriere Voiture'] = {
        ...
        NPCPos       = vec4(406.5876, -1626.0443, 28.2919, 202.1833),
    },

    ['Fourriere Paleto Bay'] = {
        impound      = true,
        impoundPrice = 50,
        type         = 'car',
        impoundIn    = false,
...
RegisterNetEvent('LeDjo_Garage:Notification')
AddEventHandler('LeDjo_Garage:Notification', function(msg)
    lib.notify({
        title = locale('Garaje'),
        description = msg,
        position = 'top',
