        ...
        onSelected = function(Index)
            if YveltAdminSanctions.Index == 1 then
                ...
                if YveltSanction then
                    ExecuteCommand('warn '..selectedPlayer.source..' '..YveltSanction)
                else
            ...
            elseif YveltAdminSanctions.Index == 2 then
                ...
                --Kick
                if YveltSanction then
                    ExecuteCommand('kick '..selectedPlayer.source..' '..YveltSanction)
                else
                    YveltHelper:clientNotification('~r~L\'action a été annulé')
                end
            elseif YveltAdminSanctions.Index == 3 then
                ...
                if YveltSanction and YveltSanction2 then
                    ExecuteCommand('jail '..selectedPlayer.source..' '..YveltSanction..' '..YveltSanction2)
                else
                    YveltHelper:clientNotification('~r~L\'action a été annulé')
                end
            elseif YveltAdminSanctions.Index == 4 then
                ...
                --Ban
                if YveltSanction and YveltSanction2 then
                    ExecuteCommand('ban '..selectedPlayer.source..' '..YveltSanction..' '..YveltSanction2)
                else
                    YveltHelper:clientNotification('~r~L\'action a été annulé')
                end
            end
