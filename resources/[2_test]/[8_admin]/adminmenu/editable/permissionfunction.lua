...
AdminFunctions = {
    ...
    CodemAdminMenuWeather = function(src, weather)
        TriggerClientEvent('codem-adminmenu:setWeather', -1, weather)
    end,
    
    CodemAdminMenuTime = function(src, hour)
        local h = tonumber(hour)
        TriggerClientEvent('codem-adminmenu:setTime', -1, h or 12)
    end,
