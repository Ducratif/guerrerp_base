...
Config.TargetConfig = {
    ["clothing"] = {
        ...
        icon = "fas fa-tshirt",
        label = "Ouvrir le mag de vetement",
        distance = 3
    },
    ["barber"] = {
    ...
    ["clothingroom"] = {
        ...
        label = "Ouvrir le menu Emploi/Vetements de gang",
        distance = 3
    },
    ["playeroutfitroom"] = {
        model = "mp_g_m_pros_01",
