...
function RageUI.Visible(Menu, Value)
    if Menu ~= nil then --and Menu() then
...
function RageUI.Banner()
    ...
    if CurrentMenu ~= nil then
        if (CurrentMenu.Display.Header) then -- CurrentMenu() and
...
function RageUI.Subtitle()
    local CurrentMenu = RageUI.CurrentMenu
    if CurrentMenu ~= nil then
        if  (CurrentMenu.Display.Subtitle) then --CurrentMenu() and
            RageUI.ItemsSafeZone(CurrentMenu)
...
function RageUI.Background()
    local CurrentMenu = RageUI.CurrentMenu;
    if CurrentMenu ~= nil then
        if (CurrentMenu.Display.Background) then --CurrentMenu() and
            RageUI.ItemsSafeZone(CurrentMenu)
