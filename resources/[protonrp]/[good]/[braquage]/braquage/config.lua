...
bijouterie = {
    ...
    houses = {	
        ...
        {	
            ...
            maximumTime = 140,  -- s	
            interiorVector = vector3(-612.8761, -258.6933, 36.3755), 	
            exitVector = vector3(-612.8761, -258.6933, 36.3755),
            outdoorVector = vector3(-612.8761, -258.6933, 36.3755), 	
            objects = {	
                {object = "DIAMAND", position =  vector3(-607.5456, -260.5194, 36.3755)},
                {object = "BIJOUX", position = vector3(-605.8579, -259.5242, 36.3755)},
                {object = "DIAMAND", position =  vector3(-603.9407, -265.5388, 37.0448)},
                {object = "BIJOUX", position = vector3(-600.8443, -266.0195, 37.0449)},
                {object = "DIAMAND", position =  vector3(-608.4084, -268.0102, 37.0450)},
                {object = "BIJOUX", position = vector3(-606.4359, -270.7120, 37.0449)},
                {object = "DIAMAND", position =  vector3(-595.8178, -261.3844, 37.0450)},
                {object = "DIAMAND", position =  vector3(-606.2808, -242.8434, 37.0450)},
                {object = "BIJOUX", position = vector3(-610.9065, -241.3449, 37.0449)},
                {object = "DIAMAND", position =  vector3(-608.4175, -242.4630, 37.0449)},
                {object = "BIJOUX", position = vector3(-612.8951, -244.6208, 37.0449)},
                {object = "DIAMAND", position =  vector3(-615.1665, -245.4860, 37.0450)},
                {object = "BIJOUX", position = vector3(-620.4336, -247.3808, 37.0450)},
                {object = "DIAMAND", position =  vector3(-618.2836, -249.7870, 37.0450)},
