...
class ChipHack {
    ...
    start_loading_sequence() {
        this.flash_icon('.chip_hack_loading_icon_1', 'Retrieving malicious code');
        setTimeout(() => {
            this.play_sound('downloaded');
            this.complete_icon('.chip_hack_loading_icon_1');
            this.flash_icon('.chip_hack_loading_icon_2', 'Deploying malicious code');
        }, this.loading_time/4);
        setTimeout(() => {
            this.play_sound('uploaded');
            this.complete_icon('.chip_hack_loading_icon_2');
            this.flash_icon('.chip_hack_loading_icon_3', 'Gaining system access');
        }, this.loading_time/2);
        setTimeout(() => {
            this.play_sound('accessed');
            this.complete_icon('.chip_hack_loading_icon_3');
            this.end_loading_sequence('System access granted');
        }, this.loading_time);
    }
